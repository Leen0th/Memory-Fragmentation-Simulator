...
class Algorithms {
    ...
    public static boolean worstFit(MemoryBlock[] memoryBlocks, String processID, int processSize, int strategy) {
        ...
        for (MemoryBlock block : memoryBlocks) {
            if (block.status.equals("free") && block.blockSize >= processSize && block.blockSize > maxSize) {
                worstBlock = block;
        ...
        if (worstBlock != null) {
            ...
            // Call fragmentation calculation method
            calculateFragmentation(worstBlock, strategy, processSize);
            System.out.printf("%s Allocated at address %d, and the internal fragmentation is %d\n",
                    processID, worstBlock.startAddress, worstBlock.internalFragmentation);
            return true;
        }
        return false;
    }
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    System.out.println("============================================================================");
                    System.out.println("Block#   Start   End   Size(KB)   Status     ProcessID   InternalFragmentation");
                    System.out.println("============================================================================");
                    for (int i = 0; i < M; i++) {
